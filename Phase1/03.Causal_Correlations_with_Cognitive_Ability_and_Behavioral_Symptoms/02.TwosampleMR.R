...
### forward MR analysis (regarding each of AD and AR as an  exposures and each of hematological traits and immune-related cells counts as an outcome) ###
exp_pheno <- c("DiagnosedAR","Anxiety2021")
out_pheno <- c("gFactor","Appetite","ConcRecent","ConcWorst","DeathWorst","Inadequacy","Interest","Movement","SleepIssues","SleepMuch","SleepTrouble","Suicide","TiredRecent","TiredWorst","WakeEarly","WorthlessWorst")
...
exp_pheno <- c("gFactor","Appetite","ConcRecent","ConcWorst","DeathWorst","Inadequacy","Interest","Movement","SleepIssues","SleepMuch","SleepTrouble","Suicide","TiredRecent","TiredWorst","WakeEarly","WorthlessWorst")
